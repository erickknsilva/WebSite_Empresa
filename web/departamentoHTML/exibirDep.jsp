    ...
    <body>
        ...
        <form action="../editarDepartamento?flag=alterarDepartamento" method="POST" class="formulario">
            ...
            <div class="dpto">
                ...
                <input type="text" name="idDepartamento" value="<%= dep.getIdDepartamento()%>" 
                       maxlength="3" minlength="2" id="idDep" required>
            </div>
            <div class="nomeEtelefone">
                <label for="nome">Nome Departamento</label>
                <input type="text" name="nomeDepartamento" value="<%= dep.getNomeDepartamento()%>"
                       maxlength="50" minlength="8" id="nome" required">


                <label for="telefone">Telefone</label>
                <input type="tel" name="telefoneDepartamento" value="<%= dep.getFoneDepartamento()%>" 
                       id="telefone" minlength="14" maxlength="15" required>
            </div>
